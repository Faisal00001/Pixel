        ...
        <div className="py-20 bg-[#F5F5F5] px-5 md:px-[65px]">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                <div className="relative group">
                    <img src={image1} className="w-full h-auto" alt="First Image" />

                    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-black to-transparent opacity-50 transition-opacity duration-500 hover:opacity-0"></div>
                    <div className="absolute top-[75%] left-5">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <FaArrowRight className="text-xl text-red-500 transition-transform duration-500 group-hover:translate-x-5"></FaArrowRight>
                        </div>
                    </div>

                </div>
                <div className="relative group">
                    <img src={image2} className="w-full h-auto" alt="Second Image" />
                    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-black to-transparent opacity-50 transition-opacity duration-500 hover:opacity-0"></div>
                    <div className="absolute top-[75%] left-5">
                ...
                <div className="relative group">
                    <img src={image3} className="w-full h-auto" alt="Thrid Image" />
                    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-black to-transparent opacity-50 transition-opacity duration-500 hover:opacity-0"></div>
                    <div className="absolute top-[75%] left-5">
